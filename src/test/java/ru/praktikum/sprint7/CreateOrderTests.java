...
public class CreateOrderTests extends CommonSteps {
    ...
    private static final String address = RandomStringUtils.randomAlphabetic(17);
    private static final int metroStation = 1 + (int) (Math.random() * 239);
    private static final int rentTime = 1 + (int) (Math.random() * 169);
