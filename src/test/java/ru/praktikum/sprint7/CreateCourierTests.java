...
public class CreateCourierTests extends CommonSteps {
    private final String randomLogin = RandomStringUtils.randomAlphabetic(10);
    private final String randomPassword = RandomStringUtils.randomAlphabetic(10);
    private final String randomFirstName = RandomStringUtils.randomAlphabetic(10);
